...
- No strong beliefs about prevalence: mean = .50 (on probability scale), sd = 1.4 (on log-odds scale)
- Prior belief prevalence is high: mean = .70 (on probability scale), sd = 1 (on log-odds scale)
- Prior belief prevalence is low: mean = .25 (on probability scale), sd = 1 (on log-odds scale)

The asymmetry between low and high is intentional, reflecting our stronger belief that low prevalences are lower than high prevalances are high.
