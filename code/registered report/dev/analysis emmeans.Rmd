...
### Prevalence marginaleffects

```{r}

est_prevalence <- function(outcome, subfield = "hypothetical typical subfield", journal = "hypothetical typical journal", type = c("conditional", "marginal"), year_centered = 0) {
  ...
  if(type == "conditional") {
    ...
    res <- 
      ...
      select(prevalence_estimate = estimate,
...
est_trend <- function(outcome, subfield = "hypothetical typical subfield", journal = "hypothetical typical journal", type = c("conditional", "marginal")) {
  ...
  if(type == "conditional") {
    ...
    res <- 
      slopes(model = fit,
             ...
             allow_new_levels = TRUE) |>
      filter(group == outcome) |>
      select(trend_estimate = estimate,
